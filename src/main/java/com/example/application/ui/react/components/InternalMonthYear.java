...
/*
    ...
    public void addValueChangeListener(Consumer<YearMonth> changeListener) {
        addStateChangeListener("value", String.class, value -> {
            changeListener.accept(YearMonth.parse(value));
        });
    }
/*
    public void setYear(int year) {
