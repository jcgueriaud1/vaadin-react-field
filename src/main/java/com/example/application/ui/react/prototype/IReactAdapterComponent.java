 ...
 * @since 24.4
 */
public interface IReactAdapterComponent extends HasElement {
    /**
     ...
     */
    default <T> DomListenerRegistration addStateChangeListener(
     ...
     *            value to assign
     */
    default void setState(String stateName, Object value) {
     ...
     *            type of the state value
     */
    default <T> T getState(String stateName, Class<T> typeClass) {
     ...
     *            type of the state value
     */
    default <T> T getState(String stateName, TypeReference<T> typeReference) {
     ...
     */
    static <T> T readFromJson(JsonValue jsonValue,
            Class<T> typeClass) {
     ...
     */
    static JsonValue writeAsJson(Object object) {
